    ...
    <div class="containerr">
        ...
        <div class="bannerContainer">
            ...
            <div class="searchPart">
                <div>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        stroke="#8894AE" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                        class="feather feather-search">
                        <circle cx="11" cy="11" r="8"></circle>
                        <line x1="21" y1="21" x2="16.65" y2="16.65"></line>
                    </svg>
                    <input class="shadow-none focus:shadow-outline focus-ring border focus:outline-none rounded-lg"
                        type="text" placeholder="Nom du professionnel de santé">
                </div>
                <div >
                    <form class="max-w-sm mx-auto l">
                        <select id="countries"
                            class="rounded-lg focus:ring-blue-500 focus:border-blue-500 focus:outline-none specialites">
                ...
                <div class="borderNone">
                    <div class="relative">
                        ...
                        <input datepicker datepicker-buttons datepicker-autoselect-today type="text"
                            class="block  ps-10 p-2.5 focus:outline-none" placeholder="choisi une date">
                    </div>
                </div>
                <button>
