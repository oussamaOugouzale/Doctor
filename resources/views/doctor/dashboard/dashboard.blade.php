                        ...
                        <ul class="main-nav">
                            ...
                            <li class="has-submenu ">
                                ...
                                <ul class="submenu">
                                    ...
                                    <li class><a href="{{ route('profile-settings-hours') }}">Profile Settings</a></li>
                    ...
                    <ul class="nav header-navbar-rht">
                        ...
                        <li class="nav-item dropdown has-arrow logged-item">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a class="dropdown-item" href="{{ route('profile-settings-hours') }}">Profile
                                    Settings</a>
                ...
                <div class="row align-items-center inner-banner">
                    <div class="col-md-12 col-12 text-center">
                        ...
                        <nav aria-label="breadcrumb" class="page-breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="https://doccure.dreamstechnologies.com/laravel/template/public">Home</a>
                                </li>
...
<!-- Mirrored from doccure.dreamstechnologies.com/laravel/template/public/doctor-dashboard by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 19 May 2024 01:33:28 GMT -->
