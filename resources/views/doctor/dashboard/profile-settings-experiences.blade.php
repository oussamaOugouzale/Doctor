...
<!-- Mirrored from doccure.dreamstechnologies.com/laravel/template/public/doctor-experience-settings by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 19 May 2024 01:36:15 GMT -->
<!-- Added by HTTrack -->
                        ...
                        <ul class="main-nav">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-2">
                                                    <div class="single-demo ">
                                                        ...
                                                        <div class="demo-info">
                                                            <a href="index-3.html" class="inner-demo-img">General
                                                                Home 2</a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-2">
                                                    <div class="single-demo ">
                                                        ...
                                                        <div class="demo-info">
                                                            <a href="index-4.html" class="inner-demo-img">General
                                                                Home 3</a>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-2">
                                                    <div class="single-demo ">
                                                        ...
                                                        <div class="demo-info">
                                                            <a href="index-12.html" class="inner-demo-img">Lab
                                                                Test</a>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-2">
                                                    <div class="single-demo ">
                                                        ...
                                                        <div class="demo-info">
                                                            <a href="index-13.html" class="inner-demo-img">Home
                                                                Care</a>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <li class="has-submenu active">
                                ...
                                <ul class="submenu">
                                    ...
                                    <li class><a href="available-timings.html">Available Timing</a></li>
                            ...
                            <li class="has-submenu ">
                                ...
                                <ul class="submenu">
                                    ...
                                    <li class="has-submenu ">
                                        ...
                                        <ul class="submenu inner-submenu">
                                            <li class><a href="doctor-profile.html">Doctor Profile 1</a></li>
                                            <li class><a href="doctor-profile-2.html">Doctor Profile 2</a></li>
                                        </ul>
                                    </li>
                                    <li class="has-submenu ">
...
<a href=" javascript:void(0);">Call</a>
                                    ...
                                    <li class="has-submenu ">
                                        ...
                                        <ul class="submenu inner-submenu">
                                            ...
                                            <li class><a href="login-email-otp.html">Email OTP</a></li>
                    ...
                    <div class="col-lg-8 col-xl-9">
                        ...
                        <div class="setting-tab">
                            <div class="appointment-tabs">
                                <ul class="nav">
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{route('profile-settings-details')}}">Basic Details</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link active" href="{{route('profile-settings-experiences')}}">Experience</a>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{route('profile-settings-hours')}}">Business Hours</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <form action="https://doccure.dreamstechnologies.com/laravel/template/public/doctor-experience-settings">
    ...
    <script src="assets/js/jquery-3.7.1.min.js" type="5d9750e7127ee176b06bbbe7-text/javascript"></script>

    <script src="assets/js/bootstrap.bundle.min.js" type="5d9750e7127ee176b06bbbe7-text/javascript"></script>

    <script src="assets/plugins/theia-sticky-sidebar/ResizeSensor.js" type="5d9750e7127ee176b06bbbe7-text/javascript"></script>
    <script src="assets/plugins/theia-sticky-sidebar/theia-sticky-sidebar.js" type="5d9750e7127ee176b06bbbe7-text/javascript"></script>

    <script src="assets/js/moment.min.js" type="5d9750e7127ee176b06bbbe7-text/javascript"></script>
    <script src="assets/js/bootstrap-datetimepicker.min.js" type="5d9750e7127ee176b06bbbe7-text/javascript"></script>

    <script src="assets/plugins/select2/js/select2.min.js" type="5d9750e7127ee176b06bbbe7-text/javascript"></script>

    <script src="assets/js/aos.js" type="5d9750e7127ee176b06bbbe7-text/javascript"></script>

    <script src="assets/js/script.js" type="5d9750e7127ee176b06bbbe7-text/javascript"></script>
    <script src="../../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="5d9750e7127ee176b06bbbe7-|49" defer></script>
</body>
