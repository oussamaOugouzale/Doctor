...
<!-- Mirrored from doccure.dreamstechnologies.com/laravel/template/public/doctor-profile-settings by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 19 May 2024 01:33:48 GMT -->
<!-- Added by HTTrack -->
...
<a href=" javascript:void(0);">Call</a>
                            ...
                            <div class="widget-profile pro-widget-content">
                                <div class="profile-info-widget">
                                    ...
                                    <div class="profile-det-info">
                                        <h3><a href="doctor-profile.html">{{Auth::guard('doctor')->user()->nom .' '.Auth::guard('doctor')->user()->prenom}}</a></h3>
    ...
    <script>
        document.getElementById('add-another').addEventListener('click', function() {
            ...
            // Ajoutez le clone à la section de formation
