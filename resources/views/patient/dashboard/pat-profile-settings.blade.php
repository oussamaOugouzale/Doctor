            ...
            <div class="container">
                <div class="row">
                            ...
                            <div class="widget-profile pro-widget-content">
                                <div class="profile-info-widget">
                                    <a href="" class="booking-doc-img">
                                        <img src="{{Auth::guard('patient')->user()->photo}}" alt="User Image">
                                    </a>
                    ...
                    <div class="col-lg-8 col-xl-9">
                        ...
                        <form action="{{route('pat-profile-settings-update')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="form-wrap">
                                            ...
                                            <select class="form-control" required name="genre">
                                                ...
                                                <option value="homme" {{ Auth::guard('patient')->user()->genre === 'homme' ? 'selected' : '' }}>Homme</option>
                                                <option value="femme" {{ Auth::guard('patient')->user()->genre === 'femme' ? 'selected' : '' }}>Femme</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-6">
                                        <div class="form-wrap">
                                            ...
                                            <input type="text" value="{{Auth::guard('patient')->user()->nom}}" required name="nom" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-6">
                                        <div class="form-wrap">
                                            <label class="col-form-label">Prénom <span class="text-danger">*</span></label>
                                            <input type="text" value="{{Auth::guard('patient')->user()->prenom}}" required name="prenom" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-6">
                                        <div class="form-wrap">
                                            <label class="col-form-label">numéro de téléphone <span class="text-danger">*</span></label>
                                            <input type="text" value="{{Auth::guard('patient')->user()->numero_tel}}" required name="numero_tel" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-6">
                                        <div class="form-wrap">
                                            <label class="col-form-label">Adresse email <span class="text-danger">*</span></label>
                                            <input type="email" value="{{Auth::guard('patient')->user()->email}}" required name="email" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-6">
                                        <div class="form-wrap">
                                            <label class="col-form-label">Age <span class="text-danger">*</span></label>
                                            <input type="text" value="{{Auth::guard('patient')->user()->age}}" required name="age" class="form-control">
                                        </div>
                                    </div>
                                </div>
                            </div>
